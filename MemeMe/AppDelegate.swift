...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        tabBarAppearance.barTintColor = UIColor.orange
        
        // Customize Table View
        let tableViewAppearance = UITableView.appearance()
        tableViewAppearance.backgroundColor = UIColor.orange
        
        // Customize TableView Cells
        let tableCellAppearance = CustomTableViewCell.appearance()
        tableCellAppearance.backgroundColor = UIColor.clear
        
        // Customize CollectionView Cells
        let collectionCellAppearance = UICollectionViewCell.appearance()
        collectionCellAppearance.backgroundColor = UIColor.clear
